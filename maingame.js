...
TheLegoMango..
https://www.khanacademy.org/profile/kaid_201685110226168971788810
*/
/******  CANVAS SETUP  ******/
...
function Player(config) {
        ...
        for (var i = 0; i < blocks[l].length; i++) {
            if (Collide(this, blocks[l][i])) {
                if (this.y < blocks[l][i].y) {
                    ...
                    this.y = blocks[l][i].y + blocks[l][i;
                    this.yVel *= -1;
                }
            }
        }
    ...
    this.checkUnderWater = function() {
        for (var i = 0; i < waters[l].length; i++) {
            if (Collide(this, waters[l][i])) {
                this.isInWater = true;
            } else {
                this.isInWater = false;
            }
...
function Water(config) {
    ...
    this.draw = function() {
        ...
        ctx.strokeStyle = "rgba(50, 50, 255, 0)";
        ctx.fillRect(this.x, this.y, this.w, this.h);
        ctx.strokeRect(this.x, this.y, this.w, this.h);
    };
}
